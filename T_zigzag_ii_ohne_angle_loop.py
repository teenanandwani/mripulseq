...
for _ in range(11):  # repeat the pattern
    ...
    gy = pp.make_extended_trapezoid(channel='y', amplitudes=np.array([0, gy.amplitude/8, gy.amplitude/8,0]), system=system, times=np.array([0, 0.5*t, 0.55*t, 0.58*t]))
    seq.add_block(adc0,gx, gy)
